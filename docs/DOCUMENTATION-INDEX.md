...
| `DEMO-HOSTING-DECISION.md`, `agent/HANDOFF.md`, `MACOS-DOCKER-COMPOSE.md`                                                         | Local validation passed; browser QA blocked; external setup pending | Use for the OrbStack/R2 demo and operator steps; do not infer the public URL is live.                                 |

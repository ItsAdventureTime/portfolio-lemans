        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="space-y-1">
                <select
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary bg-white min-h-11"
                >
            ...
            >
              ...
              <button className="w-full inline-flex items-center justify-center min-h-11 px-4 rounded-lg bg-slate-700 text-white text-xs font-semibold hover:bg-slate-600 transition-colors focus-visible:ring-2 focus-visible:ring-slate-700">
                Add Log Event
              </button>
            </form>
          </div>

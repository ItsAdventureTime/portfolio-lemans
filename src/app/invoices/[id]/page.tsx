  ...
  return (
    <div className="space-y-6">
      ...
      <div className="surface-card space-y-6 p-6">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          ...
          <div className="text-right">
            <span className="block text-sm font-medium text-slate-500">Service Invoice</span>
        ...
        <div className="grid grid-cols-1 gap-5 text-base sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            <p className="text-sm font-medium text-slate-500">VAT (12%)</p>
            <p className="mt-1 font-mono text-lg font-semibold tabular-nums text-slate-900">
      ...
      <div className="border-t border-slate-300 pt-5 text-center">
        <p className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-medium text-slate-600">

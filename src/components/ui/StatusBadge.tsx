...
export default function StatusBadge({ status }: StatusBadgeProps) {
  ...
  return (
    <span
      className={`status-badge inline-flex h-7 min-h-7 items-center justify-center gap-1.5 whitespace-nowrap rounded-md border px-2.5 text-xs font-normal leading-none ${variant.bg} ${variant.text} ${variant.border}`}
